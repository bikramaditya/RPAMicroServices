...
namespace UserInteractionService
{
    /// <summary>
    /// An instance of this class is created for each service replica by the Service Fabric runtime.
    /// </summary>
    internal sealed class UserInteractionService : StatefulService
    {
        public UserInteractionService(StatefulServiceContext serviceContext) : base(serviceContext)
		{
        }
        ...
        protected override IEnumerable<ServiceReplicaListener> CreateServiceReplicaListeners()
        {
            ...
            string listenQueueName = CloudConfigurationManager.GetSetting("moreInfoQueueName");
    ...
    internal sealed class Handler : AutoCompleteServiceBusMessageReceiver
    {
        ...
        private void sendToEmail(BrokeredMessage message)
        {
            try
            {
